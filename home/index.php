  	...
  	<div class="container">
            ...
            <form method="POST" class="mt-4" action="" enctype="multipart/form-data">
              <div class="row">
                <div class="col-lg-12 col-md-12">
                  <input type="text" name="post" class="form-control" placeholder="What's your scary story?">
                  <div style="text-align: left">
                    <img id="preview-media" src="" width="150" height="150" style="display:none;" />
                  </div>
                  <div class="post" style="text-align: left;margin-top: 10px;">
                    <input type="file" id="add-media" onchange="loadFile(event)" name="add_media" hidden>
                    <button type="button" class="btn btn-primary add-media">Add Media</button>
                    <input type="hidden" name="user_id" id="user_id" value="<?php echo $user_data[0]['user_id']; ?>" />
          ...
          <div class="row mt-5 box" style="text-align: left;">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 d-flex flex-row">
              <div class="d-flex flex-column mr-3">
                <span><?php if($post_data[0]['total_likes'] > 1){echo '<span id="like-counter-'.$post_data[0]['post_id'].'">'.$post_data[0]['total_likes'].'</span>'.' likes';}else{echo '<span id="like-counter-'.$post_data[0]['post_id'].'">'.$post_data[0]['total_likes'].'</span>'.' like';} ?></span>
                <span data-post_id="<?php echo $post_data[0]['post_id'] ?>" id="post-like-<?php echo $post_data[0]['post_id']; ?>" onclick="like(this)" class="like bi <?php if($post_data[0]['total_likes'] > 0 && $user_data[0]['user_id'] == $post_data[0]['user_id']){ echo 'bi-hand-thumbs-up-fill text-primary';}else{echo 'bi-hand-thumbs-up';} ?>"></span>
              </div>
              <div class="d-flex flex-column mr-3">
                <span><?php if($post_data[0]['total_dislikes'] > 1){echo '<span id="dislike-counter-'.$post_data[0]['post_id'].'">'.$post_data[0]['total_dislikes'].'</span>'.' dislikes';}else{echo '<span id="dislike-counter-'.$post_data[0]['post_id'].'">'.$post_data[0]['total_dislikes'].'</span>'.' dislike';} ?></span>
                <span data-post_id="<?php echo $post_data[0]['post_id'] ?>" id="post-dislike-<?php echo $post_data[0]['post_id']; ?>" onclick="dislike(this)" class="dislike bi <?php if($post_data[0]['total_dislikes'] > 0 && $user_data[0]['user_id'] == $post_data[0]['user_id']){ echo 'bi-hand-thumbs-down-fill text-primary';}else{echo 'bi-hand-thumbs-down';} ?>"></span>
              </div>
              <div class="d-flex flex-column mr-3">
          ...
          <div class="row mt-4 box" style="text-align: left;">
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 d-flex flex-row">
              <div class="d-flex flex-column mr-3">
                ...
                <span data-post_id="<?php echo $post['post_id'] ?>" id="post-like-<?php echo $post['post_id']; ?>" onclick="like(this,event)" class="like bi <?php if($post['total_likes'] > 0 && $user_data[0]['user_id'] == $post['user_id']){ echo 'bi-hand-thumbs-up-fill text-primary';}else{echo 'bi-hand-thumbs-up';} ?>"></span>
              </div>
              <div class="d-flex flex-column mr-3">
                ...
                <span data-post_id="<?php echo $post['post_id'] ?>" id="post-dislike-<?php echo $post['post_id']; ?>" onclick="dislike(this, event)" class="dislike bi <?php if($post['total_dislikes'] > 0 && $user_data[0]['user_id'] == $post['user_id']){ echo 'bi-hand-thumbs-down-fill text-primary';}else{echo 'bi-hand-thumbs-down';} ?>"></span>
              </div>
              <div class="d-flex flex-column mr-3">
        ...
        <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12" style="border: 1px solid #e5dcd0;padding: 15px;height: 650px;">
          ...
          <div class="item d-flex flex-column align-items-center" style="margin-bottom: 15px;">
            <img src="<?php if(isset($user['profile'])){echo base_url.$user['profile'];}else{echo base_url.'uploads/profile/profile.png';} ?>" width="100" height="100" class="img-responsive user-profile">
  ...
  <script type="text/javascript">
    ...
    var loadFile = function(event) {
      ...
      reader.onload = function(){
        var output = document.getElementById('preview-media');
        output.src = reader.result;
      };
      reader.readAsDataURL(event.target.files[0]);
      $('img#preview-media').show();
    };
